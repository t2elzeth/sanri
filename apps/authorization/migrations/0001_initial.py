    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('atWhatPrice', models.CharField(choices=[('by_fact', 'by_fact'), ('by_fob', 'by_fob'), ('by_fob2', 'by_fob2')], default='by_fact', max_length=255)),
                ('sizeFOB', models.IntegerField(default=0)),
                ('username', models.CharField(max_length=16, unique=True)),
                ('role', models.CharField(blank=True, max_length=255, null=True)),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('user_type', models.CharField(choices=[('superuser', 'superuser'), ('admin', 'admin'), ('sales_manager', 'sales_manager'), ('yard_manager', 'yard_manager'), ('client', 'client'), ('employee', 'employee')], default='superuser', max_length=255)),
