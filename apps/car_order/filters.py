...
class CarModelFilter(django_filters.rest_framework.FilterSet):
    ...
    mark = django_filters.CharFilter(
        field_name="carModel__mark__id", lookup_expr="istartswith"
    )
    model = django_filters.CharFilter(
        field_name="carModel__id", lookup_expr="istartswith"
    )
    vinNumber = django_filters.CharFilter(
        field_name="vinNumber", lookup_expr="istartswith"
    )
    lotNumber = django_filters.CharFilter(
        field_name="lotNumber", lookup_expr="istartswith"
    )
