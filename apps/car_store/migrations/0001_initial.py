    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('milage', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('complect', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='images', to='car_store.carstore')),
            ],
        ),
    ]
