...
class ContainerAPIView(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        elif user_type in (User.USER_TYPE_SALES_MANAGER, User.USER_TYPE_YARD_MANAGER):
            managed_users = [managed_user.user for managed_user in self.request.user.managed_users_as_manager.all()]
